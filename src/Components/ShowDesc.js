...
export default function ShowDesc() {
    ...
    const [fetchURL2, setFetchURL2] = useState(`https://api.themoviedb.org/3/movie/${Id.id}/credits?api_key=20d913bda50836a3a7c9e7ad70acab65&language=en-US`)
        ...
        <>
            ...
            <div className="MainContainer">
                ...
                <div className="textContainer">
                    ...
                    <p>Year: {data.release_date.slice(0,4)} | Duration: {parseFloat(data.runtime / 60).toFixed(1)} | Director: {director}</p>
                    <p>Cast: {cast}</p>
